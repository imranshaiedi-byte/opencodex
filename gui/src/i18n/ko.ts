...
export const ko: Record<TKey, string> = {
  ...
  "audio.notConfigured": "설정 안 됨",
  "audio.unknown": "음성 API 정보를 불러올 수 없음",
  "audio.key": "OpenCodex 데이터 키",
  "audio.file": "음성 파일 (최대 25 MB)",
  "audio.transcribe": "받아쓰기",
  "audio.transcribing": "변환 중...",
  "audio.transcript": "변환 결과",
  "audio.emptyTranscript": "감지된 음성 없음",
  "audio.examples": "API 예제",
  "audio.streaming": "스트리밍 받아쓰기",
  "audio.connect": "연결 확인",
  "audio.disconnect": "연결 해제",
  "audio.events": "세션 이벤트",
  "audio.state.idle": "확인 전",
  "audio.state.connecting": "연결 중...",
  "audio.state.connected": "세션 준비됨",
  "audio.state.disconnected": "연결 해제됨",
  "audio.state.failed": "연결 실패",
  "audio.error.auth": "키가 거부됐습니다. OpenCodex 데이터 키를 확인하세요.",
  "audio.error.unavailable": "제공자에 연결할 수 없습니다. 계정을 확인하세요.",
  "audio.error.rateLimit": "요청 한도에 도달했습니다. 잠시 후 다시 시도하세요.",
  "audio.error.invalid": "요청이 거부됐습니다. 파일과 제공자를 확인하세요.",
  "audio.error.size": "내용이 있는 25 MB 이하 음성 파일을 선택하세요.",
  ...
  "models.pickerOrder.provider": "프로바이더별",
  "models.pickerOrder.mostUsed": "사용량순 스냅샷",
  "models.pickerOrder.custom": "사용자 지정 순서",
  "models.pickerOrder.apply": "순서 적용",
  "models.pickerOrder.applying": "적용 중…",
  "models.pickerOrder.saved": "모델 선택 순서를 저장했습니다. 이전 목록이 보이면 클라이언트를 다시 열어 주세요.",
  "models.pickerOrder.pending": "순서를 저장했습니다. 카탈로그 갱신은 아직 완료되지 않았습니다.",
  "models.pickerOrder.usageFailed": "모델 사용량을 불러오지 못했습니다.",
  "models.pickerOrder.loadFailed": "모델 선택 설정을 불러오지 못했습니다.",
  ...
  "models.fastRows.loadFailed": "빠른 행 설정을 불러올 수 없습니다.",
  "models.fastRows.updateFailed": "빠른 행 설정 업데이트에 실패했습니다.",
...
"common.discard": "버리기",
  ...
  "dash.visionOff": "끔",
  "compactionRouting.title": "압축 라우팅",
  "compactionRouting.description": "Codex 압축 요청에 사용할 모델과 적용 대상을 선택하세요. 이후 메시지는 대화 설정을 유지합니다.",
  "compactionRouting.model": "압축 모델",
  "compactionRouting.effort": "추론 수준",
  "compactionRouting.triggers": "적용 대상",
  "compactionRouting.triggersManual": "수동 /compact만",
  "compactionRouting.triggersBoth": "수동과 자동",
  "compactionRouting.triggersAuto": "자동만",
  ...
  "subagentSurface.selectionTitle": "서브에이전트 서피스를 {mode}로 바꿀까요?",
  "subagentSurface.selectionBody": "{mode}에서는 v2 서피스를 쓰는 ChatGPT 모델(base에서는 Sol과 Terra, v2에서는 모든 모델)이 작업을 Grok이나 Claude 같은 routed 모델에 ChatGPT 백엔드용으로 암호화된 채 넘기고, routed 모델은 읽지 못합니다. 업스트림에서 고쳐질 때까지 이 위임은 unreadable_encrypted_agent_task로 실패합니다. v1은 프로바이더가 달라도 안정적으로 위임합니다.",
  "subagentSurface.advisoryTitle": "v1이 이제 기본 서브에이전트 서피스입니다",
  "subagentSurface.advisoryBody": "이 설치는 {mode}로 동작하며, v2 서피스의 ChatGPT 모델이 routed 모델에 읽지 못하는 암호화된 작업을 넘기기 때문에 프로바이더가 다른 위임은 깨집니다. 업스트림에서 고쳐질 때까지는 v1을 권합니다. 직접 바꾸기 전까지 현재 설정은 그대로 유지됩니다.",
  "subagentSurface.continue": "계속하기",
  "subagentSurface.switchToV1": "v1으로 바꾸기",
  "subagentSurface.learnMore": "실패하는 이유",
  ...
  "prov.modelsNoticeTitle": "모델 설정 안내",
  "prov.modelsNoticeChecking": "모델 목록을 확인하고 있습니다. 모델 스위치를 꺼도 프로바이더는 비활성화되지 않습니다.",
  "prov.modelsNoticePending": "초기 모델 목록을 아직 확인하지 못했습니다. 조회가 끝날 때까지 모델 노출을 보류합니다.",
  "prov.modelsNoticeOff": "처음 등록할 때 모델 스위치를 모두 꺼 두었습니다. 모델 페이지에서 필요한 모델을 켜세요.",
  "prov.modelsNoticeReady": "모델 페이지에서 사용할 모델을 켜거나 끌 수 있습니다. 프로바이더 자체를 끄는 것은 아닙니다.",
  "prov.modelsNoticeFailed": "프로바이더는 저장했지만 모델 목록을 갱신하지 못했습니다. 다시 시도하세요.",
  "prov.modelsNoticeCount": "모델 {count}개",
  "prov.modelsNoticeOpen": "모델 페이지로 이동",
  "models.initialSelectionPending": "초기 모델 조회 대기",
  ...
  "models.subtitle.combos": "여러 모델을 하나의 id로 묶어 순서대로 응답하게 합니다. failover로 대상을 연결하거나 분산 전략으로 부하를 나눕니다.",
  "models.subtitle.compatibility": "랩 프로젝션 증거의 읽기 전용 호환성 판정 행렬.",
  "models.subtitle.routing": "정책 프로필, dry-run 평가, 그리고 근거가 남는 라우팅 분석입니다.",
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다. 저장하면 허브 카탈로그가 갱신됩니다. 클라이언트가 사용하려면 그 카탈로그를 가져와야 하며, OpenCodex는 실행 중인 클라이언트에서 활성화됐는지 확인할 수 없습니다.",
  "models.catalogState.label": "카탈로그 전달 상태",
  "models.catalogState.saved": "허브에 저장됨",
  "models.catalogState.savedDetail": "카탈로그 변경 저장이 성공하면 확인됩니다.",
  "models.catalogState.fetched": "이 클라이언트가 가져옴",
  "models.catalogState.fetchedAt": "마지막 가져오기: {time}. 이 시각만으로 최신 허브 저장 내용이 포함됐다고 확인할 수는 없습니다.",
  "models.catalogState.fetchedUnknown": "이 클라이언트가 가져온 시각이 보고되지 않았습니다.",
  "models.catalogState.active": "실행 중인 클라이언트에서 활성화됨",
  "models.catalogState.activeUnverified": "확인되지 않음. OpenCodex는 런타임 활성화를 확인할 수 없습니다.",
  ...
  "models.orderHint": "기본 순서는 지정 모델과 카탈로그 우선순위를 따르며, 우선순위가 같은 라우팅 모델은 프로바이더·모델 순으로 정렬됩니다. 저장된 피커 순서는 표시 순서를 바꿀 수 있고, 노출 토글은 표시할 행을 필터링합니다. 클라이언트는 다시 가져오기 전까지 이전 카탈로그를 유지할 수 있습니다.",
  "models.custom": "직접 입력…",
  ...
  "pws.manageModelVisibility": "모델에서 노출 관리",
  "pws.modelOwnershipLoading": "모델 정의 확인 중…",
  "pws.modelOwnershipFailed": "모델 정의를 불러오지 못했습니다. 변경하기 전에 다시 시도하세요.",
  "pws.modelSelectionPending": "변경하기 전에 모델에서 모델 선택을 완료하세요.",
  "pws.modelSaved": "커스텀 모델 정의를 저장했습니다.",
  "pws.modelSavedHidden": "정의를 저장했습니다. 이 모델은 숨겨져 있습니다. 모델에서 노출 상태를 관리하세요.",
  ...
  "models.hide": "숨기기",
  "models.hideConfirm": "{name}을 모델 카탈로그에서 숨기시겠습니까? 정의는 삭제되지 않으며 직접 라우팅 정책도 바뀌지 않습니다.",
  ...
  "sub.ultraModeText": "능동 위임 텍스트",
  "sub.ultraModePreset": "프리셋 복원",
  "sub.ultraModeLoadFail": "능동 위임 설정을 불러오지 못했습니다 — 프록시가 실행 중인가요?",
  "sub.ultraModeSaveFail": "능동 위임 설정 저장에 실패했습니다",
  "sub.ultraModeSaved": "능동 위임 설정이 저장되었습니다. 새 Codex 세션부터 적용됩니다.",
  ...
  "logs.filter.model.all": "모든 모델",
  "logs.filter.provider.label": "공급자",
  "logs.filter.provider.all": "모든 공급자",
  "logs.filter.status.label": "상태",
  "logs.filter.status.all": "모든 상태",
  "logs.filter.status.success": "성공 (2xx)",
  "logs.filter.status.errors": "오류 (4xx/5xx)",
  "logs.filter.time.label": "시간",
  "logs.filter.time.all": "전체 시간",
  "logs.filter.time.15m": "최근 15분",
  "logs.filter.time.1h": "최근 1시간",
  "logs.filter.time.24h": "최근 1일",
  "logs.filter.speed.label": "속도",
  "logs.filter.speed.all": "모든 속도",
  "logs.filter.speed.slow": "< 15 토큰/초",
  "logs.filter.speed.medium": "15–< 50 토큰/초",
  "logs.filter.speed.fast": "≥ 50 토큰/초",
  "logs.filter.reset": "필터 초기화",
  "logs.filter.showingCount": "{total}개 중 {count}개 표시",
  "logs.noMatchingRequests": "일치하는 요청이 없습니다.",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "logs.modelTooltip.tierOutcome.confirmed": "확인됨",
  "logs.modelTooltip.tierOutcome.assumed": "추정됨",
  "logs.modelTooltip.tierOutcome.downgraded": "강등됨",
  "logs.modelTooltip.tierOutcome.unknown": "알 수 없음",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
  ...
  "codexSet.base.title": "기본 프롬프트",
  "codexSet.base.prev": "이전 옵션",
  "codexSet.base.next": "다음 옵션",
  "codexSet.base.position": "{position} / {total}",
  "codexSet.base.swipeHint": "좌우로 스와이프하거나 방향키 또는 화살표 버튼으로 옵션을 넘깁니다. 새로 시작하는 세션에 적용됩니다.",
  "codexSet.base.defaultTitle": "Codex 자체 기본 프롬프트",
  "codexSet.base.defaultBody": "기본값은 여기에 저장되지 않으므로 편집하거나 삭제할 것이 없습니다. 선택하면 설정에서 model_instructions_file을 지우고 Codex가 기본 제공 프롬프트를 씁니다.",
  "codexSet.base.variantTitle": "이름",
  "codexSet.base.variantBody": "프롬프트",
  "codexSet.base.replacesWarning": "Codex 자체 기본 프롬프트에 덧붙이는 게 아니라 통째로 바꿉니다. 여기에 짧게 쓰면 모델도 그만큼 짧은 지시만 받습니다.",
  "codexSet.base.use": "이걸로 쓰기",
  "codexSet.base.inUse": "사용 중",
  ...
  "integrations.aside.syncNow": "지금 동기화",
  "integrations.aside.applied": "{total}개 중 {count}개 적용됨",
  "integrations.aside.current": "사용 중",
  "integrations.aside.profile": "프로필 {id}",
  "integrations.aside.toggle": "{name} 동기화",
  "integrations.aside.details": "{name} 관리",
  "integrations.aside.back": "전체 Aside 프로필",
  "integrations.aside.empty": "Aside를 열고 연결할 프로필을 만드세요.",
  "integrations.aside.partial": "일부 프로필을 확인해 주세요. 동기화 설정은 저장됐습니다. 각 프로필의 상태를 확인하세요.",
  "integrations.aside.pending": "동기화 설정 저장됨 · 파일 반영 대기 중",
  "integrations.aside.retry": "{name} 다시 시도",
  "integrations.aside.loadError": "Aside 프로필을 불러오지 못했습니다. 다시 시도해 상태를 확인하세요.",
  ...
  "integrations.catalog.title": "클라이언트",
  "integrations.rollback.older": "이전 작업",
  "integrations.rollback.showMore": "{n}개 더 보기",
  "integrations.rollback.failed": "롤백 기록을 불러오지 못했습니다.",
  ...
  "integrations.error.residualNoSnapshot": "{message} 자동 복구를 마치지 못했습니다. 다시 시도하기 전에 클라이언트 설정을 확인하세요.",
  ...
  "integrations.kind.overwrite": "덮어씀",
  "integrations.dialog.overwrite.title": "이 설정 파일의 블록을 덮어쓸까요?",
  "integrations.dialog.overwrite.changesUnowned": "{path}에서 opencodex가 써야 하는 자리를 우리가 쓰지 않은 블록이 차지하고 있습니다. 적용하면 opencodex가 쓰는 블록으로 바꿉니다.",
  "integrations.dialog.overwrite.changesForeign": "{path}의 opencodex 블록에 직접 넣은 수정은 버리고 opencodex가 쓰는 블록으로 바꿉니다.",
  "integrations.dialog.overwrite.breakage": "그 블록이 설정하던 동작은 더 이상 적용되지 않습니다. 파일의 다른 부분은 그대로 둡니다.",
  "integrations.dialog.overwrite.undo": "먼저 스냅숏을 저장하므로 아래 되돌리기 목록에 남고 다시 되돌릴 수 있습니다.",
  "integrations.dialog.overwrite.confirm": "덮어쓰기",
  "integrations.action.overwrite": "덮어쓰기",
  "integrations.preview.loading": "정확한 변경 계획을 불러오는 중…",
  "integrations.preview.failed": "변경 계획을 불러오지 못했습니다. 아무것도 변경하지 않았습니다.",
  "integrations.preview.stale": "확인하는 동안 통합 상태가 바뀌었습니다. 갱신된 계획을 검토하고 다시 확인하세요.",
  "integrations.dialog.apply.title": "이 통합을 적용할까요?",
  "integrations.dialog.apply.changes": "opencodex가 관리하는 공급자 설정을 클라이언트 구성에 추가합니다.",
  "integrations.dialog.apply.breakage": "클라이언트는 현재 이 opencodex 인스턴스가 제공하는 모델을 사용합니다.",
  "integrations.dialog.apply.undo": "먼저 백업을 저장하며 롤백 센터에서 변경을 되돌릴 수 있습니다.",
  "integrations.dialog.apply.confirm": "적용",
  "integrations.dialog.disable.title": "이 통합을 비활성화할까요?",
  "integrations.dialog.disable.changes": "opencodex가 소유한 설정만 제거합니다.",
  "integrations.dialog.disable.breakage": "클라이언트는 이 opencodex 인스턴스를 통해 라우팅되는 모델을 더 이상 사용하지 않습니다.",
  "integrations.dialog.disable.undo": "먼저 백업을 저장하며 롤백 센터에서 변경을 되돌릴 수 있습니다.",
  "integrations.dialog.disable.confirm": "비활성화",
  "integrations.plan.heading": "서버 변경 계획",
  "integrations.plan.operation": "작업: {operation}",
  "integrations.plan.operation.apply": "적용",
  "integrations.plan.operation.overwrite": "교체",
  "integrations.plan.operation.disable": "비활성화",
  "integrations.plan.operation.restore": "복원",
  "integrations.plan.change.add": "추가",
  "integrations.plan.change.replace": "교체",
  "integrations.plan.change.remove": "제거",
  "integrations.plan.change.snapshot": "백업 저장",
  "integrations.plan.change.ownership": "소유권 기록 갱신",
  "integrations.plan.change.journal": "롤백 항목 기록",
  "integrations.plan.foreign.none": "외부 편집이 감지되지 않았습니다.",
  "integrations.plan.foreign.unowned": "opencodex가 소유하지 않은 설정 블록을 교체합니다.",
  "integrations.plan.foreign.foreignEdit": "opencodex 관리 블록 안의 편집 내용을 교체합니다.",
  "integrations.plan.foreign.drift": "이 롤백 시점 이후 파일이 변경되었습니다.",
  "integrations.plan.noop.applied": "관리되는 클라이언트 문서는 변경할 필요가 없습니다. 통합 설정이 이미 있습니다.",
  "integrations.plan.noop.disabled": "관리되는 클라이언트 문서는 변경할 필요가 없습니다. 통합 설정이 이미 없습니다.",
  "integrations.plan.noop.profilePreference": "확인하면 프로필 동기화 설정은 계속 저장됩니다.",
  "integrations.plan.refused": "서버가 이 계획을 안전하게 적용할 수 없습니다.",
  "integrations.plan.refusal.notInstalled": "클라이언트가 설치되어 있지 않습니다. 설치한 뒤 페이지를 새로 고치고 변경 사항을 다시 미리 확인하세요.",
  "integrations.plan.refusal.conflict": "관리 설정이 현재 파일과 충돌합니다. 파일을 검토하거나 사용할 수 있다면 교체 작업을 선택하세요.",
  "integrations.plan.refusal.unsafe": "클라이언트 구성을 안전하게 변경할 수 없습니다. 파일을 복구하거나 교체한 뒤 다시 시도하세요.",
  "integrations.plan.refusal.nonLoopback": "이 클라이언트에는 루프백 프록시 주소가 필요합니다. localhost, 터널 또는 로컬 포워더를 사용한 뒤 다시 시도하세요.",
  "integrations.plan.refusal.driftRequiresConfirm": "이 롤백 시점 이후 파일이 변경되었습니다. 변경 상태를 반영한 계획을 검토한 뒤 복원하세요.",
  "integrations.plan.refusal.snapshotExpired": "이 롤백 시점의 백업이 만료되어 더 이상 복원할 수 없습니다.",
  "integrations.plan.refusal.writeFailed": "서버가 안전한 쓰기 작업을 준비하지 못했습니다. 통합 상태를 새로 고친 뒤 다시 시도하세요.",
  "integrations.mutation.pending": "확인한 변경 사항을 적용하는 중…",
  "integrations.bulk.breakage": "각 클라이언트는 이 opencodex 인스턴스를 통해 라우팅되는 모델을 더 이상 사용하지 않습니다.",
  "integrations.bulk.undo": "각 클라이언트는 자체 백업과 롤백 항목을 유지합니다.",
  "integrations.bulk.confirm": "모두 비활성화",
  ...
  "integrations.semantics.kilo": "Kilo 전역 설정(~/.config/kilo에서 먼저 존재하는 kilo.jsonc, kilo.json, opencode.jsonc, opencode.json, config.json)의 provider.opencodex만 관리합니다. 다른 키는 그대로 둡니다. 적용 시 파일 전체를 다시 쓰므로 주석과 후행 쉼표는 보존되지 않습니다. Kilo에서 opencodex/<모델>을 선택하세요.",
  ...
  "codexAuth.mainHardLockTitle": "메인 계정 99% 차단",
  "codexAuth.mainHardLockDesc": "5h 창이 있으면 5h, 없으면 주간 사용률을 기준으로 합니다. 월간 전용 계정은 월간을 봅니다. 0%로 리셋되면 자동으로 풀리고 설정은 유지됩니다.",
  "codexAuth.mainHardLockConfirmTitle": "메인 계정 99% 차단을 켤까요?",
  ...
  "codexAuth.mainHardLockEnabled": "99% 보호 설정을 켰습니다.",
  "codexAuth.mainHardLockDisabled": "99% 보호 설정을 껐습니다. 다른 계정 제한은 그대로 적용됩니다.",
  "codexAuth.mainHardLockLoadFailed": "설정을 불러오지 못했습니다. 다시 시도해 현재 상태를 확인하세요.",
  "codexAuth.mainHardLockSaveFailed": "저장 여부를 확인하지 못했습니다. 설정을 다시 불러온 뒤 시도하세요.",
  "codexAuth.mainHardLockRefreshFailed": "설정은 저장됐지만 계정 상태를 다시 확인하지 못했습니다. 다시 시도하세요.",
  "codexAuth.mainHardLockBlocked": "99% 보호로 차단 중",
  "codexAuth.mainHardLockUnknown": "보호 켜짐 · 사용량 확인 필요",
  "codexAuth.mainHardLockMonitoring": "99% 보호 켜짐",
  ...
  "codexAuth.ultraFastFailed": "Ultra Fast 설정을 바꾸지 못했습니다",
  ...
  "codexAuth.quotaAutoRefreshHint": "이 할당량 창이 재설정될 때 최소 테스트 메시지 하나를 보냅니다.",
  ...
  "anthropicPool.disabledDesc": "세션마다 계정 하나만 사용합니다. 429가 나면 로그인된 다른 계정으로 넘어가며, 이 동작은 끌 수 없습니다.",
  ...
  "accountPool.strategyHintQuota": "할당량 전략이 사용량 임계값에서 기존 작업을 다시 바인딩하는 것은 `pool.cacheAffinity`가 꺼져 있을 때만입니다(기본값은 켜짐). 기본값에서는 계정이 처리할 수 없을 때까지 유지하며, 그때도 실제 할당량 여유가 있는 계정으로만 옮깁니다.",
  ...
  "accountPool.quotaWindowFiveHour": "5시간 사용량",
  "accountPool.quotaWindowWeekly": "주간 사용량",
  "accountPool.quotaWindowMaxUtilization": "더 높은 사용량",
  "accountPool.quotaWindowHint": "주간은 다른 사용 가능한 계정이 남아 있을 때만 5시간 사용량이 소진된 계정을 건너뛰고, 아무 계정도 남지 않으면 해당 계정으로 폴백합니다. 주간 사용량이 같으면 5시간 사용량이 더 낮은 계정을 고르며, 계정별 주간 사용량은 공급자 페이지에서 조회한 뒤에만 알 수 있습니다.",
  "accountPool.quotaWindowInert": "할당량 전략, 또는 임계값이 0보다 큰 필 퍼스트만 사용량을 기준으로 점수를 매깁니다. 현재 로테이션 전략에서는 이 설정이 아무 영향을 주지 않습니다.",
  ...
  "grokCoupon.badgeAria": "Grok 리셋 쿠폰 {count}개",
  "grokCoupon.badgeErrorAria": "Grok 리셋 쿠폰을 읽지 못했습니다",
  "grokCoupon.title": "Grok 리셋 쿠폰",
  "grokCoupon.available": "이 계정에 리셋 쿠폰이 {count}개 있습니다.",
  "grokCoupon.desc": "쿠폰 1개로 이 계정의 Grok 사용량 윈도우를 즉시 초기화합니다.",
  "grokCoupon.none": "이 계정에는 리셋 쿠폰이 없습니다.",
  "grokCoupon.loadFailed": "이 계정의 리셋 쿠폰을 읽지 못했습니다.",
  "grokCoupon.loadFailedAuth": "쿠폰을 읽으려면 이 xAI 계정에 다시 로그인하세요.",
  "grokCoupon.retry": "다시 시도",
  "grokCoupon.couponLabel": "쿠폰 #{n}",
  "grokCoupon.couponNext": "다음 사용 대상",
  "grokCoupon.couponNextBadge": "NEXT",
  "grokCoupon.validFrom": "유효 시작 {date}",
  "grokCoupon.expires": "만료 {date} ({days}일 남음)",
  "grokCoupon.useOne": "쿠폰 1개 사용",
  "grokCoupon.fifoNote": "만료가 가장 가까운 쿠폰부터 사용됩니다.",
  "grokCoupon.confirmTitle": "리셋 쿠폰을 사용하시겠습니까?",
  "grokCoupon.confirmDesc": "이 계정의 Grok 사용량 윈도우가 즉시 초기화됩니다. 남은 쿠폰: {count}개.",
  "grokCoupon.confirmWhich": "{date}에 만료되는 쿠폰이 사용됩니다.",
  "grokCoupon.irreversible": "이 작업은 되돌릴 수 없습니다.",
  "grokCoupon.redeem": "쿠폰 사용",
  "grokCoupon.redeeming": "사용 중…",
  "grokCoupon.redeemSuccess": "쿠폰을 사용했습니다. 남은 쿠폰: {count}개.",
  "grokCoupon.redeemReplayed": "이 사용은 이전에 이미 완료되었습니다. 쿠폰이 다시 사용되지 않았습니다.",
  "grokCoupon.redeemFailed": "쿠폰 사용에 실패했습니다. 다시 시도하기 전에 쿠폰 목록을 확인하세요.",
  "grokCoupon.authFailed": "쿠폰을 사용하려면 이 xAI 계정에 다시 로그인하세요.",
  "grokCoupon.noAccount": "이 사용에 쓸 수 있는 xAI 계정이 없습니다.",
  "grokCoupon.noneAvailable": "사용 가능한 리셋 쿠폰이 없습니다.",
  "grokCoupon.identityMismatch": "해당 사용은 다른 계정에 속합니다. 이 대화상자를 닫고 다시 시작하세요.",
  "grokCoupon.networkError": "프록시에 연결할 수 없습니다.",
  "grokCoupon.capacity": "지금은 사용 저널이 가득 찼습니다. 잠시 후 다시 시도하세요.",
  "grokCoupon.noOperationId": "이 브라우저는 사용 ID를 생성할 수 없어 여기서는 쿠폰을 사용할 수 없습니다.",
  "grokCoupon.unknownOutcome": "사용 요청이 제때 응답하지 않아 결과를 알 수 없습니다. 계정을 다시 읽어 쿠폰이 사용되었는지 확인하세요.",
  "grokCoupon.checkResult": "계정 다시 읽기",
  "grokCoupon.checking": "다시 읽는 중…",
  "grokCoupon.consumedElsewhere": "이 계정에서 쿠폰이 없어졌으므로 사용이 완료되었습니다.",
  "grokCoupon.unresolved": "쿠폰이 아직 목록에 있습니다. 업스트림에서 사용이 계속 진행 중일 수 있습니다 — 다른 쿠폰을 쓰기 전에 잠시 후 다시 읽으세요.",
  ...
  "api.rotation.title": "키 교체",
  "api.rotation.description": "짧은 전환 시간 동안 기존 키를 유지한 채 새 키를 발급합니다.",
  "api.rotation.start": "키 교체 시작",
  "api.rotation.starting": "시작하는 중…",
  "api.rotation.pending": "키 교체가 대기 중입니다. 클라이언트에 새 키를 적용하고 정상 연결을 확인한 뒤 확정하세요.",
  "api.rotation.expires": "전환 가능 시간:",
  "api.rotation.secretOnce": "새 키는 지금 한 번만 표시됩니다. 이 안내를 닫기 전에 복사하세요.",
  "api.rotation.commit": "새 키로 확정",
  "api.rotation.abort": "키 교체 취소",
  "api.rotation.failed": "요청을 끝내지 못했습니다. 새로고침한 뒤 다시 시도하세요.",
  "api.rotation.startFailed": "키 교체를 시작하지 못했습니다.",
  ...
  "pws.sponsor.orcaTitle": "요청에 맞는 모델을 한곳에서",
  ...
  "modal.searchResults": "{tiers}에서 {count}개",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.xaiChatOptIn": "Grok 4.5와 4.6에 Chat Completions 사용",
  "pws.xaiChatOptInDesc": "끄면 Responses를 사용합니다. OAuth Responses 요청의 기본값입니다. 다른 Grok 모델과 티어 동작은 바뀌지 않습니다.",
  "pws.xaiChatOptInMixed": "한 모델만 Chat을 사용합니다.",
  ...
  "pws.capacity.uncalibratedPlan": "보정되지 않은 요금제 {count}개는 기본 좌석 가중치로 계산되어, 이 추정치가 실제보다 낮을 수 있습니다",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.group.other": "기타 전략",
  "cws.targetCount": "대상 {count}개",
  "cws.targetCountOne": "대상 1개",
  "cws.overviewTitle": "콤보",
  "cws.overviewBlurb": "프로바이더/모델 대상 사이를 장애 조치, 라운드로빈, 가중 랜덤, 최소 사용, 최단 쿼터 리셋으로 라우팅하는 가상 모델입니다.",
  "cws.count.total": "전체",
  ...
  "cws.strategy.random": "랜덤",
  "cws.strategy.leastUsed": "최소 사용",
  "cws.strategy.resetWindow": "리셋 윈도우",
  ...
  "cws.strategy.randomHint": "요청마다 가중치에 비례한 확률로 적합한 대상을 하나 뽑습니다. 요청 간 고정이 없습니다.",
  "cws.strategy.leastUsedHint": "각 요청을 성공 횟수가 가장 적은 적합한 대상으로 보냅니다. 횟수는 프록시 재시작 시 초기화됩니다.",
  "cws.strategy.resetWindowHint": "쿼터 윈도우가 가장 빨리 리셋되는 적합한 대상을 우선합니다. 쿼터 데이터가 없으면 설정 순서를 따릅니다.",
  "cws.field.id": "콤보 ID",
  ...
  "cws.targets.randomHint": "가중치가 각 추첨의 확률을 제어하며, 순서는 무관합니다.",
  "cws.targets.leastUsedHint": "순서는 사용량이 같은 대상 간의 동률만 결정합니다.",
  "cws.targets.resetWindowHint": "쿼터 데이터가 없거나 동률일 때 순서가 적용됩니다.",
  ...
  "connection.pairing.hub": "허브",
  "connection.pairing.getCode": "이 브라우저를 인증하려면 허브에서 다음 명령을 실행하세요.",
  "connection.pairing.askOperator": "허브를 다른 사람이 운영한다면 이 명령을 전달하고 일회용 페어링 코드를 요청하세요.",
  "connection.pairing.notApiKey": "이 칸에는 일회용 페어링 코드를 붙여 넣으세요. 데이터 API 키나 관리자 토큰을 입력하는 칸이 아닙니다.",
  "connection.pairing.networkError": "허브에 연결할 수 없습니다. 연결을 확인하고 다시 시도하세요. 입력한 코드는 유지됩니다.",
  "connection.pairing.requestError": "허브가 페어링 요청을 완료하지 못했습니다. 허브 상태를 확인하고 다시 시도하세요.",
  "connection.pairing.responseError": "허브가 유효한 브라우저 세션을 반환하지 않았습니다. 허브를 업데이트하거나 운영자에게 확인한 뒤 다시 시도하세요.",
  "dash.authRequired": "이 대시보드를 보려면 브라우저 인증이 필요합니다.",
  "dash.permissionDenied": "이 브라우저에는 대시보드 조회 권한이 없습니다. 서버 운영자에게 접근 설정을 확인하세요.",
  "dash.dataUnavailable": "대시보드 데이터를 불러오지 못했습니다. 연결을 확인하고 다시 시도하세요.",
  "dash.staleData": "마지막으로 받은 데이터를 표시합니다. 최신 상태와 다를 수 있습니다.",
  ...
  "connection.pairing.error": "페어링 코드가 거부되었거나 만료되었습니다. 확인할 수 있도록 입력값은 유지했습니다.",
  "connection.machine.title": "이 머신",
  "connection.machine.shimHealthy": "Codex shim이 정상입니다.",
  "connection.machine.shimNeedsAttention": "Codex shim을 확인해야 합니다.",
  "connection.machine.repairShim": "shim 복구",
  "connection.machine.removeShim": "shim 제거",
  "connection.clients.title": "연결된 클라이언트",
  "connection.clients.none": "클라이언트 상태 없음",
  "connection.clients.sync": "지금 동기화",
  "connection.clients.syncing": "동기화 중…",
  ...
  "integrations.detail.cursorSeen": "최근 Cursor가 이 프록시를 호출함",
  "integrations.detail.cursorNeverSeen": "Private Inference 설치됨, 아직 요청 없음",
  "integrations.detail.cursorAbsent": "Cursor Private Inference를 찾지 못함",
  "integrations.cursor.title": "Cursor",
  "integrations.cursor.intro": "Cursor Private Inference는 에이전트를 로컬에서 돌리고 loopback으로 opencodex와 통신합니다. 일반 Cursor는 백엔드가 커스텀 엔드포인트를 호출하므로 공개 HTTPS 주소가 필요합니다. 이 페이지는 Cursor에 아무것도 쓰지 않습니다. 아래 값을 직접 Cursor에 붙여넣으세요.",
  "integrations.cursor.loading": "Cursor 상태 읽는 중…",
  "integrations.cursor.unavailable": "프록시에서 Cursor 상태를 읽지 못했습니다.",
  "integrations.cursor.detection": "설치된 빌드",
  ...
  "integrations.cursor.gatewayHint": "Cursor Private Inference에서 Settings > Models > Gateway를 열고 아래 두 값을 붙여넣은 뒤 Refresh model list를 누르세요.",
  "integrations.cursor.baseUrl": "Base URL",
  "integrations.cursor.apiKey": "API 키",
  "integrations.cursor.apiKeyCredential": "opencodex API 키 중 하나 (이 바인드는 자격 증명이 필요)",
  "integrations.cursor.copy": "복사",
  "integrations.cursor.copied": "복사됨",
  "integrations.cursor.connection": "연결",
  "integrations.cursor.seen": "Cursor의 마지막 요청: {time} ({ua})",
  "integrations.cursor.neverSeen": "프록시 시작 후 Cursor 요청이 없습니다. 게이트웨이 저장 후 Cursor에서 Refresh model list를 누르세요.",
  "integrations.cursor.models": "Cursor에 표시될 항목",
  "integrations.cursor.modelsHint": "Reasoning 사다리는 Cursor 자체 모델 표가 정하므로 opencodex는 예측만 합니다. Context는 기본 창과 옵트인 창(Cursor의 Max Mode)입니다.",
  ...
  "integrations.cursor.ladderFromStatic": "Reasoning 사다리는 Cursor 3.18.25의 정적 미러입니다(읽을 수 있는 Private Inference 번들을 찾지 못함). Context는 기본 창과 옵트인 창입니다.",
  "integrations.cursor.unknownVersion": "버전 미상",
  "integrations.cursor.noControl": "—",
  "integrations.cursor.singleWindow": "단일 창",
  "integrations.cursor.noControlTitle": "이 id는 Cursor 내장 effort 표에 없어서 Cursor가 Reasoning 컨트롤을 보여주지 않습니다.",
  "integrations.cursor.effortRowsOne": "effort 행 1개 게시됨",
  "integrations.cursor.effortRowsMany": "effort 행 {n}개 게시됨",
  ...
  "integrations.cursor.colModel": "모델",
  ...
  "pricing.override.action": "가격",
  "pricing.override.actionLabel": "{model} 가격 편집",
  "pricing.override.badge": "수동 가격",
  "pricing.override.title": "모델 가격",
  "pricing.override.modelId": "모델 ID",
  "pricing.override.help": "토큰 100만 개당 USD입니다. 입력·출력 요율을 입력하세요. 빈 캐시 요율은 0으로 처리하며, 네 요율이 모두 0이면 무료입니다.",
  "pricing.override.input": "입력",
  "pricing.override.output": "출력",
  "pricing.override.cacheRead": "캐시 읽기",
  "pricing.override.cacheWrite": "캐시 쓰기",
  "pricing.override.loading": "저장된 가격을 불러오는 중…",
  "pricing.override.loadFailed": "저장된 가격을 불러오지 못했습니다. 다시 불러와 주세요.",
  "pricing.override.outcomeUnknown": "요청 결과를 확인하지 못했습니다. 가격이 변경되었을 수 있으니 저장된 가격을 다시 불러온 뒤 편집하세요.",
  "pricing.override.recoveryFailed": "저장된 가격을 확인하지 못해 편집이 잠겨 있습니다. 다시 불러와 주세요.",
  "pricing.override.recovered": "현재 저장된 가격을 불러왔습니다. 이전 요청이나 다른 클라이언트가 이후에 가격을 변경할 수 있습니다.",
  "pricing.override.refreshFailed": "가격은 저장했지만 모델 목록을 갱신하지 못했습니다. 목록 갱신을 다시 시도하세요.",
  "pricing.override.invalid": "입력·출력 요율을 입력하세요. 모든 요율은 0 이상 1,000,000 이하의 유한한 숫자여야 합니다.",
  "pricing.override.reset": "자동 가격으로 복원",
  "pricing.override.save": "저장",
  "pricing.override.saving": "저장 중…",
  "pricing.override.reload": "가격 다시 불러오기",
  "pricing.override.refresh": "목록 갱신",
  "pricing.override.cancel": "취소",
  "pricing.override.close": "닫기",
  "usage.range.custom": "기간 직접 지정",
  "usage.range.start": "시작 (현지 시간)",
  "usage.range.end": "종료 (현지 시간)",
  "usage.range.apply": "적용",
  "usage.range.clear": "해제",
  "usage.range.help": "현지 시간 기준이며, 종료 시각의 마지막 분 전체를 포함합니다.",
  "usage.range.required": "시작과 종료 날짜 및 시간을 모두 입력하세요.",
  "usage.range.invalid": "1970-01-01 UTC 이후의 유효한 현지 날짜와 시간을 입력하세요.",
  "usage.range.reversed": "종료 시각은 시작 시각과 같거나 이후여야 합니다.",
  "usage.range.applied": "선택한 기간: {start} – {end} (양 끝 시각 포함).",
  "models.pickerOrder.editorHint": "라우팅 모델의 순서를 바꾼 뒤 초안을 저장하세요. 추천 모델은 고정되며 네이티브 모델은 표시하지 않습니다.",
  "models.pickerOrder.nativeLocked": "저장된 순서에 네이티브 모델이 포함되어 있습니다. 라우팅 프리셋이나 기본값을 적용한 뒤 사용자 지정 순서를 편집하세요.",
  "models.pickerOrder.unknownChosen": "추천 모델 정보를 확인할 수 없습니다. 다시 불러온 뒤 편집하세요.",
  "models.pickerOrder.changed": "모델 선택 설정이 바뀌었습니다. 초안은 유지됩니다. 다시 불러오면 초안을 버리고 현재 설정을 사용합니다.",
  "models.pickerOrder.savedReload": "순서가 저장되었습니다. 다시 편집하려면 현재 설정을 불러오세요.",
  "models.pickerOrder.requestFailed": "요청에 실패했습니다. 초안은 유지됩니다. 재시도하거나 다시 불러오세요.",
  "models.pickerOrder.empty": "사용 가능한 라우팅 모델이 없습니다.",
  "models.pickerOrder.dragModel": "{model} 끌어서 이동",
  "models.pickerOrder.featured": "추천 모델",
  "models.pickerOrder.upModel": "{model} 위로 이동",
  "models.pickerOrder.downModel": "{model} 아래로 이동",
  "models.pickerOrder.position": "{model}: {total}개 중 {position}번째",
